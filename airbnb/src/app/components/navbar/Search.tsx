    ...
    return (
        ...
        rounded-full shadow-sm hover:shadow-md transition cursor-pointer">
            <div className="flex flex-row items-center justify-between">
                ...
                <div className="text-sm pl-6 pr-2 text-gray-600 flex flex-row items-center justify-center gap-3">
                    <div className="hidden md:block">Add Guests</div>
                    <div className="p-2 bg-rose-500 rounded-full text-white flex">
                        <BiSearch size={10} />
                    </div>
                </div>
            </div>
